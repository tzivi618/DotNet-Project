...
//    private const string ARRAYOFCUSTOMER = "ArrayOfCustomer";
...
//            bool customerFound = xml.Element(ARRAYOFCUSTOMER)?.Elements().Any(c => c.Element(CUSTOMERID)?.Value == item.CustomerId.ToString()) ?? false;
//            Console.WriteLine(xml.Element(ARRAYOFCUSTOMER)?.Elements().Any(c => c.Element(CUSTOMERID)?.Value == item.CustomerId.ToString()));
//            if (customerFound)
//            {
...
//            var arrayOfCustomerElement = xml.Element(ARRAYOFCUSTOMER) ?? new XElement(ARRAYOFCUSTOMER);
//            if (arrayOfCustomerElement.Parent == null)
//            {
//                xml.Add(arrayOfCustomerElement);
//            }

//           arrayOfCustomerElement.Add(new XElement(CUSTOMER,
...
//            xml.Save(xmlFilePath); // שמירה על השינויים
...
//        {
//            XElement xml = XElement.Load(xmlFilePath);
//            xml.Descendants(CUSTOMER).FirstOrDefault(c => (int)c.Element(CUSTOMERID) == id).Remove();
//            xml.Save(xmlFilePath); // שמירה על השינויים
...
//        {
//            XElement xml = XElement.Load(xmlFilePath);
//            XElement customerFound = xml.Descendants(CUSTOMER)
...
//            Customer foundCutomer = listFoundCustomers.FirstOrDefault(customer => filter(customer));
...
//        {
//            XElement xml = XElement.Load(xmlFilePath);
//            xml.Element(ARRAYOFCUSTOMER).Add(new XElement(CUSTOMER,
//                        new XElement(CUSTOMERID, item.CustomerId),
//                        new XElement(CUSTOMERNAME, item.CustomerName),
//                        new XElement(CUSTOMERADDRESS, item.CustomerAddress),
//                        new XElement(CUSTOMERPHONE, item.CustomerPhone)));
